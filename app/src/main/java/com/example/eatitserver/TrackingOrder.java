...
import com.example.eatitserver.databinding.ActivityTrackingOrderBinding;
    ...
    private void displayLocation() {
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if (mLastLocation != null) {
                ...
                //Add Market in your location and move the camera
                ...
                //After add Market for your location, Add Market for this Order and Draw route
